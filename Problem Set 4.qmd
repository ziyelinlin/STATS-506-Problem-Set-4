...
covid %>% 
  ...
  labs(title = "Earliest States to Experience Substantial Covid Mortality",
       subtitle = "dashed line marks first date with at least 2 deaths per 100k, grey line is the national median",
       x = NULL) +
  theme_minimal() +
